...
module.exports.onChat = async ({ api, event }) => {
  ...
  const cMessages = ["🎀 Hello bby!", "🎀 আমি বট না 👊 তুমি বট!", "🎀 Hey! কেমন আছেন?😝"];
